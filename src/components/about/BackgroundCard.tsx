          ...
          <div className="border-l-4 border-primary p-4 md:p-6">
            ...
            <CollapsibleContent className="mt-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-base md:text-lg prose dark:prose-invert max-w-none">
                  <p className="leading-relaxed">
                    As a Freelance GenAI Engineer, I architected and deployed production-ready AI agents and
                    voice bots for diverse clients. Previously, I utilized my architectural background to 
                    design structured, robust ML pipelines for complex data analysis tasks.
                  </p>
                </div>
              </div>
