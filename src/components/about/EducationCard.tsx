            ...
            <CollapsibleContent className="mt-6 space-y-4">
              <div className="bg-white/80 dark:bg-black/20 rounded-lg p-4 backdrop-blur-sm hover:bg-white/90 dark:hover:bg-black/30 transition-colors">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-semibold text-primary text-lg">Bachelor of Architecture</h4>
                    <p className="text-foreground text-sm mt-1">Foundation in Design Systems & Structured Thinking</p>
                  </div>
