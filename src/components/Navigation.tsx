      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        >
          <Link to="/" className="flex items-center gap-2 text-xl font-semibold hover:text-primary transition-colors">
            <div className="h-10">
              <img 
                src="/lovable-uploads/ghazi-profile-professional.png" 
                alt="Mohammad Ghazi Ul Islam" 
  ...
  return (
    <>
      <Button variant="ghost" size="icon" className="rounded-full hover:bg-primary/10" asChild>
        <a href="https://github.com/ghazi-ai137" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <Github className="h-4 w-4" />
        </a>
      </Button>
      <Button variant="ghost" size="icon" className="rounded-full hover:bg-primary/10" asChild>
        <a href="https://linkedin.com/in/mohammad-ghazi-ul-islam" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <Linkedin className="h-4 w-4" />
        </a>
      </Button>
      <Button variant="ghost" size="icon" className="rounded-full hover:bg-primary/10" asChild>
        <a href="mailto:mohammadghazi.ai137@gmail.com" aria-label="Email">
