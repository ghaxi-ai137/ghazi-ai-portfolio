...
export const HeroContent = ({ typewriterWords }: HeroContentProps) => {
  ...
  return (
    ...
    >
      ...
      >
        GenAI Engineer specialized in production-grade AI systems, model orchestration, and full-stack AI development. Building structured, robust AI pipelines.
      </motion.p>
